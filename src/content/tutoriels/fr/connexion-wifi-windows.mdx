...
Faites la combinaison de touches suivante : <KBD keys={['Windows', 'R']} /> et tapez ensuite <Code code='control.exe /name Microsoft.NetworkAndSharingCenter' inline/>.
...
Faites la combinaison de touches suivante: <KBD keys={['Windows', 'R']} /> et tapez ensuite <Code code='control' inline/>.
